...
- Campaign context: header picker (New / Rename / Delete) switches the active campaign; party, encounter presets, and Lore pages swap with it; live encounter/dice stay session-global
...
**Terminology:** Catalog, Table, Library, Tracker, Board, Builder, Forge, Lore (durable campaign pages), Campaign (owns party / presets / lore / maps meta), party, encounter preset, threat/difficulty budget, stat block, spine (system color mark on list rows), custom library, user save, counter, random table.
