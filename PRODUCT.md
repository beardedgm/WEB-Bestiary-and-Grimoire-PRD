...
- Lore mode: multi-campaign markdown pages (`bg.lore.v1`) with nested page tree, tags and filtering, edit/preview, and **Pin to Board**; linked Lore cards render the current page markdown and show an honest missing-page notice after deletion; portable save includes Lore campaigns/pages
