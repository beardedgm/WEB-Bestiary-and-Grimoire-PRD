...
**Terminology:** Catalog, Table, Library, Tracker, Board, Builder, Forge, party, encounter preset, threat/difficulty budget, stat block, spine (system color mark on list rows), custom library, user save, counter, random table.
