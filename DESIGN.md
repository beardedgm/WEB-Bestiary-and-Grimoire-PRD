...
- A successful import with anything to report (skipped or pruned maps, dropped customs, missing media) keeps the dialog open with "Imported — …" in the notice line; only a clean import closes it. The live region alone is not a place a sighted GM will read a warning
