...
- Touch/coarse pointer: 44px minimum on tracker damage/heal/remove, catalog add, Board card ops / primary card controls, Forge band buttons, Lore editor / format / tree-add chips, and Maps list-row controls (title / Rename / ✕) on the narrow breakpoint
