...
You summon a celestial, monitor, or fiend whose level is Creature Type=monitor;fiend;celestial to fight on your behalf. Alternatively, you can choose a magical animal from the Outer Sphere as your lesser servitor. This animal is your choice of an eagle, guard dog, or raven|b2. It gains the alignment matching your deity (or you, if you don't have a deity) and has the following trait depending on the alignment it gained: celestial for lawful, monitor for neutral, or fiend for evil.
...
Heightening the spell increases the maximum level of creature you can summon and might add additional animal servitors, which otherwise work like the eagle, guard dog, and raven|b2.

---

**Heightened (2nd)** Creature Type=monitor;fiend;celestial.

**Heightened (3rd)** Creature Type=monitor;fiend;celestial. You can summon a black bear|b2, giant bat, or leopard.

**Heightened (4th)** Creature Type=monitor;fiend;celestial. You can summon a great white shark or tiger.
