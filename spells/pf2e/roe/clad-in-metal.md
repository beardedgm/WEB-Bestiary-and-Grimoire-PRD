...
You briefly swap the outer surface of the metal in an object with a suitable amount of a common precious metal from the Plane of Metal|RoE. You can instead choose an uncommon or rare metal if you have access to it or the GM has given you access to it.
