...
**Success** The target believes everyone it sees is a potential threat. It becomes unfriendly|PC1 to all creatures to which it wasn't already hostile|PC1, even those that were previously allies. It treats no one as an ally. The spell ends after 1 round.
