...
Each creature that comes within range has to attempt a save when you Sustain|PC1 the Spell. If you're speaking, enthrall gains the linguistic trait.
...
**Failure** The target is fascinated|PC1 with you. It can attempt another Will save if it witnesses actions or speech with which it disagrees. If it succeeds, it's no longer fascinated|PC1 and is temporarily immune for 1 hour. If the target is subject to a hostile|PC1 act, or if another creature succeeds at a Diplomacy|PC1 or Intimidation|PC1 check against it, the fascination ends immediately.
