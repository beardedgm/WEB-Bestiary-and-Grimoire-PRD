...
*uncommon, concentrate, manipulate, mental*
...
**Failure** During the first 5 minutes of the spell's duration, you can Sustain|PC1 the Spell to modify a memory once each round. When you do, you imagine up to 6 seconds of memory to modify, to a maximum of 5 continuous minutes of memory.
